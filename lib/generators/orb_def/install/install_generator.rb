  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def copy_initializer
        template "orb_def.rb", "config/initializers/orb_def.rb"
        template "pagy.rb", "config/initializers/pagy.rb"
        template "geokit_config.rb", "config/initializers/geokit_config.rb"
      end
